...
<!-- 파일다운로드시 새창 안띄우기 -->
			...
			<div class="ip1" style="top: 840px; position: relative;">
			    ...
			    <select id="item" title="select color">
			        ...
			        <option value="/SoftPhone/Setup60d.exe">소프트폰 (Setup60d.exe)</option>
			        <option value="/SoftPhone/Setup70d.exe">소프트폰 (Setup70d.exe)</option>
	 		        <option value="/SoftPhone/2KSoftPhone.exc">신규패치 (2KSoftPhone.exe)</option>
				<option value="/SoftPhone/config.60.txt">설정파일 (config.60.txt)</option> 
			        <option value="/SoftPhone/config.70.txt">설정파일 (config.70.txt)</option>
			      <!--  <option value="/SoftPhone/but_bg_over.png">설정파일 (config.ini)</option> -->
