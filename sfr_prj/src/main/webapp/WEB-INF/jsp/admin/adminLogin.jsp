		...
		function login() {
			...
			$.ajax({   
				...
				//	console.log(data);
					...
					if(data.code == '0'){
						if(data.auth == '0'){  // 시스템관리자
							alert('시스템관리자');			
							location.href = "/admin/superMain.do";
							
						}else if(data.auth == '1'){   //일반관리자
							alert('일반관리자');
							location.href = "/admin/main.do";
							
						}else if(data.auth == '2'){   //슈퍼관리자
							alert('슈퍼관리자');
							location.href = "/admin/superMain.do";
						}
	...
	<!--Login-->
		...
		<input type="hidden" name="loginFlag" id="loginFlag" />
			...
			<!--loginWrap-->
				<div class="loginWrap">
					<div class="loginBox">
						<div class="loginBox_img"><span class="txt1">관리자 로그인</span></div>
						<!--loginBox_01-->
