		...
		if (mildsc == 'A') {
			$('#treeA').jstree({
				...
				nodeId = data.node.id;
 					...
 					window.open('./onpeOrganization.do?page='+0+'&mildsc='+mildsc+'&nodeId='+nodeId+'', 'organization'
						...
						<span class="a1">
                           <select id="tar_range" class="select">
                             <option value="tot">통합검색</option>
						           						<option value="full_dept_nm">소속</option>
	                                                    <option value="nm">이름</option>
	                                                    <option value="rspsblt_biznes,rspofc_nm">직책</option>
	                                                    <option value="facility_nm">시설물명</option>
							    						<option value="telno2">사무실번호</option>
							    						<option value="mpno2">휴대번호</option>
                           </select>
                        </span>
						<span class="a2">
                           <input type="text" class="frm" name="query" id="query" value="" title="검색어를 입력하세요" onkeydown="JavaScript:Enter_Check();">
       ...
       <div id="result_tab2" class="tabcontent">
          <div class="org">
			  <span class="radio">
                ...
                <label for="national">국방부/힙참</label>
