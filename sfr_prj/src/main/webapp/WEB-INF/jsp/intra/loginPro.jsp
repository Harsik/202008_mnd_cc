...
<body>
<div class="login"><a href="javascript:void(0);"><img src="../images/intra/login.jpg"></a></div>
	...
	Login
		...
		<input type="hidden" name="loginFlag" id="loginFlag" />
			...
			loginWrap
				<div class="loginWrap">
					<div class="loginBox">
						<div class="loginBox_img"><span class="txt1">사용자 로그인</span></div>
						loginBox_01
						<div class="loginBox_01">
							<div class="login_header"><img src="../images/intra/login.jpg" alt="국방부" /><span class="txt2">전화번호 통합검색</span></div>
							<div class="inputBox">
								<div class="input01">
									<div class="cont mgb10"><p style="color: red;">각 부대 포탈에서 로그인 후 사용가능합니다.</p></div>
									</div>
							</div>     
						</div>
						//loginBox_01
