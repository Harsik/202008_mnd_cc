...
<%@ include file="/WEB-INF/jsp/layout/include/incHeader.jspf" %>
	...
	<script type="text/javascript">
		...
		function fnFacAdd() {
			...
			if(confirm("일반관리자를 등록 하시겠습니까?")){
				
				$('select').removeAttr("disabled");
				
				$.ajax({   
					url:"/admin/generalManagerInsert.do",
					type:"post",
					dataType:'json',
					data:$("#frm").serialize(),
		...
		<div class="content_main">
			...
			<div class="contents_a">
				...
				<div class="tbl_bottom">
					<div class="t_right">
					  <button type="button" name="btnAdd" id="btnAdd" class="btnComm grblue addBt" title="등록" onclick="fnFacAdd();">등록</button>
					  <button type="button" name="btnCancle" id="btnCancle" class="btnComm gr_line ml5" title="취소" onClick="history.back();">취소</button>
					</div>
				</div>
				</form>
				<!--//btn_area-->
