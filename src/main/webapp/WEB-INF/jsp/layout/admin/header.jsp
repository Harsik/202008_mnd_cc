...
<!-- 상단 레이아웃 -->
<script src="/MaWebDRM/jquery-1.11.3.min.js"></script>
    	...
    	<div class="m_wrap">
			...
			<div class="gnb_ad">
				<ul>
					...
					<li><a href="/admin/generalManagerList.do" class="menu " >시설물 일반관리자 </a></li>
				...
				<ul>
					...
					<li><a href="/admin/main.do" class="menu ">시설물명 현황</a></li>
