...
var XW_ERROR_CODE_SIGN_DUPLICATE	= 24000538;
...
AnySignForPCInterface.prototype.setCertificateFromPFX = function (aPFX,
																  aKeyword,
																  aOption,
																  aSearchType,
																  aSearchValue,
																  ...
																  aCallback)
{
	...
	{
		this.mSandBox.crypto().setCertificateFromPFX (aPFX,
													  aKeyword,
													  aOption,
													  aSearchType,
													  aSearchValue,
														...
														aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().signData (aXgateAddress,
										 aMediaID,
										 aIssuerRDN,
										 aCertSerial,
										 aKeyword,
														...
														aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().signDataAdd (aXgateAddress,
											aMediaID,
											aIssuerRDN,
											aCertSerial,
											aKeyword,
													   ...
													   aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "getCertPEM")) return;} catch(e) {}
		this.mSandBox.crypto().getCertPEM (aMediaID,
										   aIssuerRDN,
										   aCertSerial,
										   aOption,
										   aCallback);
...

{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "signDataWithPFX")) return;} catch(e) {}
		this.mSandBox.crypto().signDataWithPFX (aPlain,
												aPFXPath,
												aKeyword,
												aOption,
												aAdd,
													 ...
													 aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "setIdNum")) return;} catch(e) {}
		this.mSandBox.crypto().setIdNum (aId_num,
										 aCallback);
	}
}
														 ...
														 aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().envelopIdNum (aXgateAddress,
											 aMediaID,
											 aIssuerRDN,
											 aCertSerial,
											 aKeyword,
																...
																aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "envelopIdNumWithPFX")) return;} catch(e) {}
		this.mSandBox.crypto().envelopIdNumWithPFX (aPFXPath,
													aKeyword,
													aSvrCert,
													aCallback);
	}
...
AnySignForPCInterface.prototype.getVidInfo = function (aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "getVidInfo")) return;} catch(e) {}
		this.mSandBox.crypto().getVidInfo(aCallback);
	}
}
														   ...
														   aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "verifyPassword")) return;} catch(e) {}
		this.mSandBox.crypto().verifyPassword (aMediaID,
											   aIssuerRDN,
											   aCertSerial,
											   aPasswd,
											   aCallback);
															  ...
															  aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "deleteCertificate")) return;} catch(e) {}
		this.mSandBox.crypto().deleteCertificate (aMediaID,
												  aCertType,
												  aIssuerRDN,
												  aCertSerial,
												  aCallback);
															   ...
															   aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "changeCertPassword")) return;} catch(e) {}
		this.mSandBox.crypto().changeCertPassword (aMediaID,
												   aIssuerRDN,
												   aCertSerial,
												   aOldKeyword,
												   aNewKeyword,
																  ...
																  aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "checkPFXPwdWithFilter")) return;} catch(e) {}
		this.mSandBox.crypto().checkPFXPwdWithFilter (aFileName,
													  aKeyword,
													  aMediaType,
													  aSearchValue,
													  aSearchSerial,
														...
														aCallback)
{
	...
	{
		var ResultCallback = function (aResult)
		{
			if (aResult == 0)
				aCallback (0);
			else
		...
		try {if (!Integrity.checkIntegrity("XCrypto", "checkPFXPwd")) return;} catch(e) {}
		this.mSandBox.crypto().checkPFXPwd (aFileName,
											aKeyword,
											ResultCallback);
	}
}
													   ...
													   aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().importCert (aMediaID,
										   aKeyword,
										   aPFXKeyword,
										   aPFXPath,
										   aSignCertPath,
															...
															aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "exportCertToPFX")) return;} catch(e) {}
		this.mSandBox.crypto().exportCertToPFX (aMediaID,
												aIssuerRDN,
												aCertSerial,
												aPKCS8Keyword,
												aPKCS12Keyword,
															  ...
															  aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "importCertFromPFX")) return;} catch(e) {}
		this.mSandBox.crypto().importCertFromPFX (aMediaID,
												  aPFXPath,
												  aPFXKeyword,
												  aOption,
												  aCallback);
															   ...
															   aUserCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "requestCertificate")) return;} catch(e) {}
		this.mSandBox.crypto().requestCertificate (aCAPort,
												   aCAAddr,
												   aMediaID,
												   aRefNum,
												   aAuthCode,
															 ...
															 aUserCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "renewCertificate")) return;} catch(e) {}
		this.mSandBox.crypto().renewCertificate (aCAPort,
												 aCAAddr,
												 aIssuerRDN,
												 aCertSerial,
												 aMediaID,
																...
																aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().envelopeDataWithPEM (aPlainData,
													aEnvelopeOption,
													aPEMCert,
													aCallback);
	}
																 ...
																 aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().envelopeDataWithCert (aPlainData,
													 aEnvelopeOption,
													 aMediaIDList,
													 aIssuerRDNList,
													 aCertSerialList,
																   ...
																   aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "envelopeDataWithPasswd")) return;} catch(e) {}
		this.mSandBox.crypto().envelopeDataWithPasswd (aPlainData,
													   aEnvelopeOption,
													   aKeyword,
													   aCallback);
	}
																   ...
																   aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().deEnvelopeDataWithCert (aEnvelopedData,
													   aMediaID,
													   aIssuerRDN,
													   aCertSerial,
													   aKeyword,
																	 ...
																	 aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "deEnvelopeDataWithPasswd")) return;} catch(e) {}
		this.mSandBox.crypto().deEnvelopeDataWithPasswd (aEnvelopedData,
														 aKeyword,
														 aCallback);
	}
}
...
AnySignForPCInterface.prototype.setErrCodeAndMsg = function ()
{
	...
	{
		aResult.code = this.mSandBox.crypto().getLastErrCode();
																 ...
																 aMediaID)
{
	...
	this.mSandBox.crypto().setCacheCertLocation (aXgateAddress,
												 aMediaID);
}
																 ...
																 aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().getCacheCertLocation (aXgateAddress,
													 aCallback);
	}
}
																   ...
																   aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "getCacheCertLocationEx")) return;} catch(e) {}
		this.mSandBox.crypto().getCacheCertLocationEx (aXgateAddress,
													   aOption,
													   aCallback);
	}
}
															 ...
															 aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "checkPasswordLen")) return;} catch(e) {}
		this.mSandBox.crypto().checkPasswordLen (aKeyword,
												 aKeywordconfirm,
												 aConfirm,
												 aCallback);
	}
																...
																aCallback)
{
	...
	{
		try {if (!Integrity.checkIntegrity("XCrypto", "checkPasswordLenExt")) return;} catch(e) {}
		this.mSandBox.crypto().checkPasswordLenExt (aKeyword,
													aKeywordconfirm,
													aConfirm,
													aCallback);
	}
														  ...
														  aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().hasCachedData (aXgateAddress,
											  aCallback);
	}
}
														   ...
														   aCallback)
{
	...
	else
	{
		...
		this.mSandBox.crypto().clearCachedData (aXgateAddress,
												aOption,
												aCallback);
	}
}
...
AnySignForPCInterface.prototype.xfsLogin = function (aUserID,
													 ...
													 aCallback)
{
	this.mSandBox.crypto().xfs_user_login (aUserID,
										   aKeyword,
										   aSecondYn,
										   aCode,
										   aCallback);
...
{
	this.mSandBox.crypto().xfs_user_logout (aCallback);
}

AnySignForPCInterface.prototype.xfsRequest = function (aUserID,
													   aCallback)
{
	this.mSandBox.crypto().xfs_otp_request (aUserID,
											aCallback);
}

AnySignForPCInterface.prototype.xfsValid = function (aUserID,
													 aKeyword,
													 aCallback)
{
	this.mSandBox.crypto().xfs_otp_valid (aUserID,
										  aKeyword,
										  aCallback);
}
...
// private
	...
	function __initXCrypto () {
		if (__SANDBOX.xcrypto == null) {
			...
			// XecureFreeSign init
			__SANDBOX.xcrypto.xfs_init (AnySign.mXecureFreeSignData.serviceURL,
		...
		__SANDBOX.xcrypto.setProperty (AnySign.mLanguage, AnySign.mCharset);
	...
	function __isFailed (aResult, aErrCallback)
	{
		if ( (typeof(aResult) == "string" && aResult === "") || (typeof(aResult) == "number" && aResult !== 0 ))
		{
			...
			{
				if (aErrorObject.code == 20000008) { // integrity fail
			...
			function _sign() {
				...
				__resultCheckFun = function (aResult)
				{
					...
					if (aResult == "") {
						...
						if (aErrorObject.code == XW_ERROR_CODE_SIGN_DUPLICATE) {
...
return {
	...
	{
		this.RequestCertificateEx2WithWebCMP (aCAPort, null, aCAAddr, null, null, aRefNum, aAuthCode, aCAType, aReqOption, aCAName, aRAName, aSaveOption, aUserCallback, aErrCallback, aUbiKeyUserCallback);
	},

	RequestCertificateEx2WithWebCMP: function(aCAPort, aCAHTTPPort, aCAAddr, aCAHTTPAddr, aCAHTTPService, aRefNum, aAuthCode, aCAType, aReqOption, aCAName, aRAName, aSaveOption, aUserCallback, aErrCallback, aUbiKeyUserCallback)
	{
		__SANDBOX.setAfterAction (function () {
			var aKeyword;
			var aMediaID;
	...
	RenewCertificateWithSerial: function(aCAPort, aCAAddr, aCertSerial, aCertLocation, aCAType, aKeywordTryLimit, aUserCallback, aErrCallback) {
		this.RenewCertificateWithSerialWithWebCMP (aCAPort, null, aCAAddr, null, null, aCertSerial, aCertLocation, aCAType, aKeywordTryLimit, aUserCallback, aErrCallback);
	},

	RenewCertificateWithSerialWithWebCMP: function(aCAPort, aCAHTTPPort, aCAAddr, aCAHTTPAddr, aCAHTTPService, aCertSerial, aCertLocation, aCAType, aKeywordTryLimit, aUserCallback, aErrCallback) {
		var aDialogParam = {};
		var aDialogArgs = {};
		var aGuideModule;
		var aGuideDialog = null;
